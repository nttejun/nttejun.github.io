...
프로젝트 PM을 맡았으며 팀의 원활한 소통으로 업무 효율과 개발에 집중할 수 있는 개발환경을 만들기 위해 **협업과 버전관리에는 Github을** 사용하였습니다.<br>
프로젝트의 기능 구현은 **사용자가 촬영한 이미지에 4개의 간판 꼭지점을 찍으면 네 점을 사용하여 wapping 기법으로 기울어진 이미지를 정방향 이미지로 변환을** 구현하였습니다.<br>
로그인 화면 **Kakao API를 사용하여 계정연동** 시 프로필 이미지를 사용하였으며, 음식점을 검색하여 음식점 클릭 시 해당 가게의 **위치 및 정보를 채팅방에 공유할 수 있는 링크기능을 구현하였습니다.** <br>
사용자가 메뉴를 검색하면 해당 음식점 정보를 제공하는 **검색기능을 구현**하였으며, 기존 JSP 내 복잡한 자바 코드를 모두 제거하고, 페이지 이동없이 **검색결과를 빠르게 제공할 수 있도록 Ajax를 사용하였습니다** <br>
